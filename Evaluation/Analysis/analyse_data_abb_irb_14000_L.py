...
def main():
    ...
    theta_desired = File_IO.Load(f'{project_folder}/Data/ABB_IRB_14000_L/theta_desired', 'txt', ',')
    theta_actual = File_IO.Load(f'{project_folder}/Data/ABB_IRB_14000_L/theta_actual', 'txt', ',')
