...
def main():
    ...
    theta_desired = File_IO.Load(f'{project_folder}/Data/ABB_IRB_120/theta_desired', 'txt', ',')
    theta_actual = File_IO.Load(f'{project_folder}/Data/ABB_IRB_120/theta_actual', 'txt', ',')
